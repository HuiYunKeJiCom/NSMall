...
@interface NSNewFirmOrderTVCell()
@property (nonatomic, strong) UIView  *bgView;
@end


@implementation NSNewFirmOrderTVCell
...
-(void)setModel:(NSBuyNowModel *)model{
    ...
    [userIV sd_setImageWithURL:[NSURL URLWithString:model.user_avatar]];
    ...
    NSInteger buyNum = 0;
        ...
        if(model.spec_name){
            ...
            specLab.text = [NSString stringWithFormat:@"尺寸规格: %@",model.spec_name];
        ...
        numLab.text = [NSString stringWithFormat:@"x%lu",(long)model.buy_number];
        ...
        height = CGRectGetMaxY(goodsV.frame);
    ...
    totalTitle.text = [NSString stringWithFormat:@"共%lu件商品,小计",(long)buyNum];
