...
//    headView
    ...
    for(int i=0;i<shopModel.productList.count;i++){
        ...
        NSString *str = [NSString stringWithFormat:@"N%.2f/¥%.2f",goodsModel.price,goodsModel.score];
        ...
        NSString *shipStr = [NSString stringWithFormat:@"N%.2f/¥%.2f",goodsModel.ship_price,goodsModel.ship_score];
...
//    footView
    ...
    NSString *totalStr = [NSString stringWithFormat:@"N%.2f/¥%.2f",shopModel.sum_price,shopModel.sum_score];
