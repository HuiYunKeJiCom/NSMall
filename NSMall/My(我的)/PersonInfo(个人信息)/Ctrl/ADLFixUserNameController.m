...
@interface ADLFixUserNameController ()
...
@implementation ADLFixUserNameController
...
//        }
//
//        param[@"newphone"] = self.contentField.text;
//
//        WEAKSELF
...
//                userModel.phone = self.contentField.text;
