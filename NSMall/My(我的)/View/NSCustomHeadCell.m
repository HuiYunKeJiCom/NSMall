...
-(void)createUI{
    ...
    self.userName.text = KLocalizableStr(@"张三丰");
    ...
    self.daysRecord.y = CGRectGetMaxY(self.userName.frame)+GetScaleWidth(13);
    self.daysRecord.font = [UIFont systemFontOfSize:kFontNum15];
    self.daysRecord.textColor = KColorText323232;
    self.daysRecord.text = KLocalizableStr(@"来诺商108天了!");
