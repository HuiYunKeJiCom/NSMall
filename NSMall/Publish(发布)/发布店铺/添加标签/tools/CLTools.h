...
// 标签展示页
#define kCLTag_Normal_TextColor UIColorFromRGB(0x0aa1e0)      // 标签默认文本颜色
#define kCLTag_Selected_TextColor [UIColor whiteColor]         // 标签选中状态下文本颜色
#define kCLTag_Normal_BorderColor UIColorFromRGB(0x0aa1e0)    // 标签默认border颜色
#define kCLTag_Selected_BorderColor UIColorFromRGB(0x0aa1e0)  // 标签选中状态下border颜色
#define kCLTag_Normal_BackgroundColor [UIColor whiteColor]        // 标签默认背景颜色
#define kCLTag_Selected_BackgroundColor UIColorFromRGB(0x0aa1e0) // 标签选中状态下背景颜色

// 最近标签页
#define kCLHeadViewdHeight 44                   // 最近标签页title的高度
#define kCLRecentTitleFont 13                   // 最近标签页title的font

#define kCLRecentTag_Normal_TextColor UIColorFromRGB(0xd2d2d2)    // 标签默认文本颜色
#define kCLRecentTag_Selected_TextColor UIColorFromRGB(0x0aa1e0)  // 标签选中状态下文本颜色
#define kCLRecentTag_Normal_BorderColor UIColorFromRGB(0xd2d2d2)  // 标签默认border颜色
#define kCLRecentTag_Selected_BorderColor UIColorFromRGB(0x0aa1e0)// 标签选中状态下border颜色
