...
+ (instancetype)initWithTagDesc:(LabelItemModel *)tagStr {
    CLTagButton *tagBtn = [[CLTagButton alloc] init];
    tagBtn.model = tagStr;
    [tagBtn setTitle:tagStr.label_name forState:UIControlStateNormal];
    ...
    CGSize size = [tagStr.label_name sizeWithAttributes:@{NSFontAttributeName:tagBtn.titleLabel.font}];
...
-(void)setModel:(LabelItemModel *)model{
    _model = model;
}
