...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, TopBarHeight, kScreenWidth, kScreenHeight) style:UITableViewStylePlain];
...
- (void)setUpNavTopView
{
    ...
    [topToolView setTopTitleWithNSString:@"选取文件"];
    WEAKSELF
